...
class NumericalA():
    ...
    def scale(self):
        ...
        self.steps2=np.linspace(self.minbin/5,self.gaussanalyt[1]*20,20000)
        ...
        for value in self.locallike:
            ...
            mean = newstepsl[inti]
            #print(const,mean)
            self.para, pcov2 =curve_fit(NumericalA.gauss,newstepsl,self.probabilities[m],p0=[const,mean,mean])
        ...
        self.steps3 = np.linspace(1,totalguess*40,5000) # these steps are used for plotting for logsums
...
b = NumericalA(c,5000,5)
#results.append([b.max_x,b.max_y, b.parameterA])
#b = NumericalA(c,1200,10)
#results.append([b.max_x,b.max_y, b.parameterA])
#b = NumericalA(c,2000,50)
#results.append([b.max_x,b.max_y, b.parameterA])
print(results)
